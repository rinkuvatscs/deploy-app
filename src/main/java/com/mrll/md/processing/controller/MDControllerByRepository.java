...
@RestController
@RequestMapping(value="/api/md/repository/" , produces = MediaType.APPLICATION_JSON_VALUE)
public class MDControllerByRepository {
	...
	@RequestMapping(value = "/addcustomerbyrepo" , method= RequestMethod.POST)
